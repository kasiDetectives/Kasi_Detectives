...
let UsersService = class UsersService {
    ...
    login(email, password) {
        return firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]().signInWithEmailAndPassword(email, password).then((result) => {
            this.setCurrentSession(firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]());
            return result;
        }).catch((error) => {
    ...
    register(email, password, name) {
        return firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]().createUserWithEmailAndPassword(email, password).then((data) => {
            this.setCurrentSession(firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]());
            let userEmail = email;
            let userName = name;
    ...
    passwordReset(emailAddress) {
        firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]().sendPasswordResetEmail(emailAddress).then(() => {
            // Email sent.
