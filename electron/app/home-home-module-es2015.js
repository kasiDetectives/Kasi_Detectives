...
let HomePage = class HomePage {
    constructor(events, toastCtrl, platform, userService) {
        this.events = events;
    ...
    goToMyLocation() {
        ...
        this.map.getMyLocation().then((location) => {
            ...
            this.map.on(_ionic_native_google_maps__WEBPACK_IMPORTED_MODULE_4__["GoogleMapsEvent"].MAP_READY).subscribe((data) => {
