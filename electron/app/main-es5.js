...
var map = {
	"./community-event/community-event.module": [
	...
	"./report-alert/report-alert.module": [
...
module.exports = "<ion-app>\r\n  <ion-menu>\r\n    <ion-header  style=\"margin: 0; padding: 0\">\r\n      <ion-toolbar color=\"tertiary\">\r\n        <ion-title>Menu</ion-title>\r\n      </ion-toolbar>\r\n    </ion-header>\r\n\r\n    <ion-content  style=\"margin: 0; padding: 0\" color=\"success\">\r\n      <ion-list  style=\"margin: 0; padding: 0\">\r\n        <ion-menu-toggle auto-hide=\"false\" color=\"tertiary\">\r\n            \r\n                <ion-item *ngIf=\"!homePage\" (click)=\"auto('home')\" color=\"success\" style=\"margin: 0\">\r\n                    <ion-icon name=\"home\"></ion-icon>&nbsp;<ion-label>Home</ion-label>\r\n                  </ion-item>\r\n           \r\n              <ion-list-header color=\"tertiary\">\r\n                <ion-label >Report</ion-label>\r\n              </ion-list-header>\r\n\r\n              <ion-item (click)=\"auto('report-alert')\" color=\"success\">\r\n                <ion-icon name=\"alert\"></ion-icon>&nbsp;<ion-label>Crime alert</ion-label>\r\n              </ion-item>\r\n              <ion-item  (click)=\"auto('community-event')\" color=\"success\">\r\n                <ion-icon name=\"people\"></ion-icon>&nbsp;<ion-label>Community event</ion-label>\r\n              </ion-item>\r\n              \r\n              <ion-list-header color=\"tertiary\">\r\n                  <ion-label>Account</ion-label>\r\n                </ion-list-header>\r\n                \r\n                <ion-item *ngIf=\"!email\" (click)=\"auto('registration')\" color=\"success\">\r\n                  <ion-icon name=\"person-add\"></ion-icon>&nbsp;<ion-label>Sign Up</ion-label>\r\n                </ion-item>\r\n                <ion-item *ngIf=\"!email\"  (click)=\"auto('login')\" color=\"success\">\r\n                  <ion-icon name=\"log-in\"></ion-icon>&nbsp;<ion-label>Sign In</ion-label>\r\n                </ion-item>\r\n                <ion-item  *ngIf=\"email\" (click)=\"signOut('home')\" color=\"success\">\r\n                    <ion-icon name=\"log-out\"></ion-icon>&nbsp;<ion-label>Sign Out</ion-label>\r\n                  </ion-item>\r\n            \r\n            \r\n            \r\n              \r\n        </ion-menu-toggle>\r\n        <!-- <ion-menu-toggle auto-hide=\"false\" *ngFor= 'let x of appMenu'>\r\n          <ion-item  [routerLink]=\"[x.url]\">\r\n           <ion-icon name=\"{{x.icon}}\"></ion-icon>&nbsp;<ion-label>{{x.title}}</ion-label>\r\n          </ion-item>\r\n          <ion-item  [routerLink]=\"[report]\">\r\n            <ion-icon name=\"{{photo}}\"></ion-icon>&nbsp;<ion-label>Photo</ion-label>\r\n           </ion-item>\r\n           <ion-item  [routerLink]=\"[x.url]\">\r\n            <ion-icon name=\"{{x.icon}}\"></ion-icon>&nbsp;<ion-label>{{x.title}}</ion-label>\r\n           </ion-item>\r\n        </ion-menu-toggle> -->\r\n        </ion-list>\r\n      </ion-content>\r\n  </ion-menu>\r\n  <ion-router-outlet main></ion-router-outlet>\r\n</ion-app>\r\n\r\n"
...
/* harmony import */ var _navigation_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./navigation.service */ "./src/app/navigation.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, route, navigationService, events) {
    ...
    AppComponent.prototype.checkBool = function () {
        var _this = this;
        console.log("dddddddddd");
        this.events.subscribe('menu:clicked', function (boolean) {
            _this.bollean = boolean;
            console.log(boolean);
            console.log("dddd");
        });
    };
    AppComponent.prototype.checkPage = function () {
        var _this = this;
        this.events.subscribe('currentPage:home', function (boolean) {
            _this.homePage = boolean;
        });
    };
    AppComponent.prototype.checkUser = function () {
        var _this = this;
        this.events.subscribe('user:created', function (email) {
            console.log(email);
            _this.email = email;
        });
    };
    AppComponent.prototype.auto = function (url) {
        console.log(url);
        this.route.navigate([url]);
        this.navigationService.pageNavigator(url);
        //this.userService.returnUserProfile()
    };
    AppComponent.prototype.signOut = function (url) {
        if (url === 'home') {
...
var NavigationService = /** @class */ (function () {
    ...
    NavigationService.prototype.pageNavigator = function (url) {
        this.pageURL = url;
        console.log(this.pageURL);
    };
    NavigationService.prototype.returnPageURL = function () {
        console.log(this.pageURL);
        return this.pageURL;
    };
...
module.exports = __webpack_require__(/*! C:\Users\CodeTribe\Kasi_Detectives\src\main.ts */"./src/main.ts");
