...
var database = firebase__WEBPACK_IMPORTED_MODULE_3__["database"]();
var UsersService = /** @class */ (function () {
    ...
    UsersService.prototype.login = function (email, password) {
        var _this = this;
        return firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]().signInWithEmailAndPassword(email, password).then(function (result) {
            _this.setCurrentSession(firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]());
            return result;
    ...
    UsersService.prototype.register = function (email, password, name) {
        var _this = this;
        return firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]().createUserWithEmailAndPassword(email, password).then(function (data) {
            _this.setCurrentSession(firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]());
            var userEmail = email;
            var userName = name;
    ...
    UsersService.prototype.passwordReset = function (emailAddress) {
        firebase__WEBPACK_IMPORTED_MODULE_3__["auth"]().sendPasswordResetEmail(emailAddress).then(function () {
            // Email sent.
    ...
    UsersService.prototype.checkState = function () {
        if (!this.currentState) {
            this.router.navigate(['/login']);
        }
    };
    UsersService.prototype.returnState = function () {
        return this.currentState;
    };
    UsersService.prototype.setCurrentSession = function (user) {
        var _this = this;
        console.log("running");
        var uid;
        if (user !== null) {
            ...
            console.log(uid);
            var userRoot = firebase__WEBPACK_IMPORTED_MODULE_3__["database"]().ref("Users").child(uid);
            userRoot.once("value", function (snap) {
                console.log(userRoot);
                var values = snap.val();
                console.log(values["displayName"]);
                console.log(values["email"]);
                _this.userProfile.push({
                    key: snap.key,
    ...
    UsersService.prototype.destroyUserData = function () {
        this.userProfile.pop();
        console.log(this.userProfile);
    };
    UsersService.prototype.readCurrentSession = function () {
        console.log(this.user);
        return this.user;
    };
    UsersService.prototype.returnUserProfile = function () {
        console.log(this.userProfile);
